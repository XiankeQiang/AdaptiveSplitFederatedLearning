...
download_speed, upload_speed = 10,10#get_network_speed()
print("client",client_order,download_speed,upload_speed)
ini_msg = {
...
for r in range(rounds):  # loop over the dataset multiple times
    ...
    download_speed, upload_speed = random.randomint(1,20),random.randomint(1,20)
    msg = {
        'client_weights':res_net_client.state_dict(),
        'uploadspeed': upload_speed,
    }
    print("client uploadspeed",upload_speed,"clent downloadspeed",download_speed)
    send_msg(s, msg)
